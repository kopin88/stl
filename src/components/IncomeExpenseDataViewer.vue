  ...
  <div>
    ...
    <v-ons-row style="margin-top:20px">
      <div class="table-responsive">
        <table class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 500px;" role="grid" aria-describedby="datatables_info">
          <thead>
            <tr role="row">
    ...
    <v-ons-row width="100%">
      ...
      <v-ons-col class="text-center" width="30%">
        {{model.from}} - {{model.to}} of {{model.total}}
      </v-ons-col>
      <v-ons-col width=10%>
      </v-ons-col>
      <v-ons-col class="text-centert" width="10%">
        <small>page: </small>
      </v-ons-col>
      <v-ons-col class="text-center" width="10%">
